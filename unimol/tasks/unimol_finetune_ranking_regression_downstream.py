...
@register_task("mol_finetune_ranking_regression_downstream")
class UniMolFinetuneRankingRegressionDownstreamTask(UnicoreTask):
    ...
    def load_dataset(self, split, **kwargs):
        ...
        if split == "train":
            tgt_rank_dataset = KeyDataset(dataset, "ranking_label")
            tgt_reg_dataset = KeyDataset(dataset, "regression_label")
        ...
        nest_dataset = NestedDictionaryDataset(
            {
                ...
                "target": {
                    "rank_target": RawLabelDataset(tgt_rank_dataset),
                    'reg_target': RawLabelDataset(tgt_reg_dataset),
                },
